<hr>
{!! Form::model($thread,['files' => 'true', 'url' => action('Administration\ThreadsController@'.$action, ['channel' => $thread]), 'method' => $action == "store_thread" ? 'Post' : 'Put', 'class' => 'form-horizontal'])  !!}
    <div class="row">
        <div class="col-md-6">
